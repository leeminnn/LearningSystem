...
#hr enroll learner
@app.route('/enroll_learner', methods=['POST'])
def enroll_learner():
    ...
    return("Successfully enroll learner"), 200
...
def available_classes():
    ...
    cur.execute("SELECT class_id, class_name FROM course.class WHERE course_id=%s",(course_id))
