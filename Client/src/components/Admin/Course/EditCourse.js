    ...
    return (
        <div>
            ...
            <div style={{ margin: '0 20%', alignItems:'flex-end', justifyContent:'flex-end', display:'flex'}}>
                <Button variant="contained" color='error' onClick={deleteCourse} >Delete Course</Button>
            </div>
            <div className='approve_box'>
                <div className='header'>
                    <div className='text' style={{alignItems:'baseline'}}>
                        <p style={{marginRight:'10px'}}>({id})</p>
                        <TextField id="standard-basic" variant="standard" fullWidth value={courseName} onChange={(e)=>setCourseName(e.target.value)}
                    ...
                    <div className='content'>
                        <div>
                            ...
                            <div style={{display:'flex', alignItems:'center'}}>
                                <div style={{marginRight: '20px', width: '200px'}}>Course Description:</div>
