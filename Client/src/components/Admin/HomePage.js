        ...
        <div className="course_box">
          ...
          <div>
            ...
            <div className="button">
              <Link to="/course/edit" style={{ textDecoration: "none" }}>
                <Button
                  onClick={() => nextPage({ entry })}
                  variant="outlined"
                  style={{ margin: "0 30px" }}
                >
                  Edit
              ...
              <Link to="/course/classes" style={{ textDecoration: "none" }}>
                <Button onClick={() => nextPage({ entry })} variant="contained">
                  View Classes
                </Button>
              </Link>
            </div>
