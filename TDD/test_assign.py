...
from assign import app, db, Class_List
...
class TestInsertEmployee_Success(TestApp):
    def test_insert_employee(self):
        assign = Class_List(emp_id=13,emp_name='Buck',class_id=1,progress='0',class_status='Ongoing',ungraded_result='0,0,0,0',graded_result='')
        request_body= {
    ...
    def test_insert_class_failed(self):
        assign = Class_List(emp_id=20,emp_name='Jessie',class_id=1,progress='0',class_status='Ongoing',ungraded_result='0,0,0,0',graded_result='')
